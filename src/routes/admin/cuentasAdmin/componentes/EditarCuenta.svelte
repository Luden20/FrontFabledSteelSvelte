...
<form on:submit={handleSubmit} class="registro-form needs-validation" novalidate>
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control" id="CUE_NOMBRE" name="CUE_NOMBRE" type="text" value={cuenta.CUE_NOMBRE} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CUE_APELLIDO" class="form-label">Apellido</label>
            <input class="form-control" id="CUE_APELLIDO" name="CUE_APELLIDO" type="text" value={cuenta.CUE_APELLIDO} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CUE_FECHA_NACIMIENTO" class="form-label">Fecha de Nacimiento</label>
            <input class="form-control" id="CUE_FECHA_NACIMIENTO" name="CUE_FECHA_NACIMIENTO" type="date" value={toDateOnly(cuenta.CUE_FECHA_NACIMIENTO)} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CUE_FECHA_CREACION" class="form-label">Fecha de Creación</label>
            <input class="form-control" id="CUE_FECHA_CREACION" name="CUE_FECHA_CREACION" type="date" value={toDateOnly(cuenta.CUE_FECHA_CREACION)} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CUE_EMAIL" class="form-label">Email</label>
            <input class="form-control" id="CUE_EMAIL" name="CUE_EMAIL" type="email" value={cuenta.CUE_EMAIL} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CUE_PASSWORD" class="form-label">Password</label>
            <input class="form-control" id="CUE_PASSWORD" name="CUE_PASSWORD" type="text" value={cuenta.CUE_PASSWORD} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="ESTADO" class="form-label">Estado</label>
            <input class="form-control" id="ESTADO" name="ESTADO" type="text" value={cuenta.ESTADO} readonly />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control" id="CLI_NOMBRE" name="CLI_NOMBRE" type="text" value={cuenta.cliente?.CLI_NOMBRE} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CLI_APELLIDO" class="form-label">Apellido</label>
            <input class="form-control" id="CLI_APELLIDO" name="CLI_APELLIDO" type="text" value={cuenta.cliente?.CLI_APELLIDO} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CLI_DIRECCION" class="form-label">Dirección</label>
            <input class="form-control" id="CLI_DIRECCION" name="CLI_DIRECCION" type="text" value={cuenta.cliente?.CLI_DIRECCION} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CLI_CODIGO_POSTAL" class="form-label">Código Postal</label>
            <input class="form-control" id="CLI_CODIGO_POSTAL" name="CLI_CODIGO_POSTAL" type="text" value={cuenta.cliente?.CLI_CODIGO_POSTAL} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CLI_CELULAR" class="form-label">Celular</label>
            <input class="form-control" id="CLI_CELULAR" name="CLI_CELULAR" type="text" value={cuenta.cliente?.CLI_CELULAR} />
        </div>
        <div class="col-md-6 mb-3">
            <label for="CLI_CEDULA" class="form-label">Cédula</label>
            <input class="form-control" id="CLI_CEDULA" name="CLI_CEDULA" type="text" value={cuenta.cliente?.CLI_CEDULA} />
        </div>
    </div>
